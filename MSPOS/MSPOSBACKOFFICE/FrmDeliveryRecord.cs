...
{
    public partial class frmDailySalesSummary1 : Form
    {
        ...
        public frmDailySalesSummary1()
        {
            ...
            try
            {
                ...
                dummyitemno = frmItemStock1.mitemno.ToString();                   
                
                SqlDataAdapter cmd = new SqlDataAdapter("select * from serialno_transtbl where barcodeno = '" + dummyitemno + "' and inout = 1"  , con);
               ...
               // SqlDataAdapter adp101 = new SqlDataAdapter(cmdGetDate);
                ...
                for (int mn = 0; mn < dtTemp.Rows.Count; mn++)
                {
                    ...
                    loadDailydetails(dtTemp.Rows[mn][2].ToString(), mn);
                ...
                //grdDailySummary.Columns[0].Width = 200;
        ...
        public void loadDailydetails(string fitemno ,int row) 
        {
            try
            {
                ...
                grdDailySummary.Rows[row].Cells["S_Retail"].Value = fitemno; 
        ...
        private void btn_Exit_Click(object sender, EventArgs e)
        {
            try
            {
                frmItemStock1 frm = new frmItemStock1(); 
      ...
      (Select (case when (SUM(disc_amt+Othdisc_Amt+spl_discamt)) is null then 0 else (SUM(disc_amt+Othdisc_Amt+spl_discamt)) end) as RDisc from stktrn_table where strn_type=2 and ctr_no=@CounterNo and strn_rtno<>0 and Strn_Cancel=0 and strn_date between @FromDate and @ToDate ) as Disc2", con);
        ...
        private void frmDailySalesSummary1_Load(object sender, EventArgs e)
        {
            //For Color settings
        ...
        private void grdDailySummary_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
