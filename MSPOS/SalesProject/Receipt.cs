        ...
        public static String[] GetFilesFrom(String searchFolder, String[] filters, bool isRecursive)
 {
    ...
    return filesFound.ToArray();
        ...
        public Receipt()
        {
            ...
            string[] QueName = { "No", "Yes" };
            string[] TaxType = { "Bottom", "Top" };
            string[] HouseACAddress = { "No", "Yes" };
            string[] PrinterType = { "None", "A4" };
            string[] printurate = { "No", "Yes" };
...
//                        dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                    ...
                    if (rptdt.Rows[i]["Rdesc"].ToString() == "Print Top Line 6")
                    {
                        dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();

                    }
                    if (rptdt.Rows[i]["Rdesc"].ToString() == "Print Top Line 7")
                    {
                        dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();

                    }
                    if (rptdt.Rows[i]["Rdesc"].ToString() == "Print URate")
                    {
                        dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                    ...
                    if (rptdt.Rows[i]["Rdesc"].ToString().Trim() == "Queue Name")
                    {
                        //dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                        (dataGridView3.Rows[i].Cells[1] as DataGridViewComboBoxCell).DataSource = QueName;
                        dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                    }
                    if (rptdt.Rows[i]["Rdesc"].ToString().Trim() == "Tax Type")
                    {
                        //dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                        (dataGridView3.Rows[i].Cells[1] as DataGridViewComboBoxCell).DataSource = TaxType;
                        dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                    }
                    if (rptdt.Rows[i]["Rdesc"].ToString().Trim() == "House A/C Address")
                    {
                        //dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                        (dataGridView3.Rows[i].Cells[1] as DataGridViewComboBoxCell).DataSource = HouseACAddress;
                        dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                    }
                    if (rptdt.Rows[i]["Rdesc"].ToString().Trim() == "PrinterType")
                    {
                        //dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                        (dataGridView3.Rows[i].Cells[1] as DataGridViewComboBoxCell).DataSource = PrinterType;
                        dataGridView3.Rows[i].Cells[1].Value = rptdt.Rows[i]["Rprop"].ToString();
                    }
                }
            }
        ...
        public void customtext()
        {
            ...
            for (int j = 0; j < dataGridView2.Rows.Count; j++)
            {
                ...
                if (Convert.ToString(dataGridView2.Rows[j].Cells["cDesc"].Value).Trim() == "Top Line6")
                {
                ...
                if (Convert.ToString(dataGridView2.Rows[j].Cells["cDesc"].Value).Trim() == "Top Line7")
                {
        ...
        public void rptset()
        {
            ...
            for (int j = 0; j < dataGridView3.Rows.Count; j++)
            {
                ...
                //if (Convert.ToString(dataGridView3.Rows[j].Cells["RDesc"].Value).Trim() == "Print Top Line 6")
                //{
                ...
                //}
                //if (Convert.ToString(dataGridView3.Rows[j].Cells["RDesc"].Value).Trim() == "Print Top Line 7")
                //{
                ...
                if (dataGridView3.Rows[j].Cells["RDesc"].Value.ToString().Trim() == "Queue Name")
                {
                    SqlCommand cmd = new SqlCommand("update Rptset set Rprop=@C1 where Rdesc='" + dataGridView3.Rows[j].Cells["RDesc"].Value + "'", con);
                    {
                        cmd.Parameters.Add(new SqlParameter("@C1", SqlDbType.VarChar));
                    }
                    cmd.Parameters["@C1"].Value = dataGridView3.Rows[j].Cells["Rprop"].Value;
                ...
                if (dataGridView3.Rows[j].Cells["RDesc"].Value.ToString().Trim() == "Tax Type")
                {
                    SqlCommand cmd = new SqlCommand("update Rptset set Rprop=@C1 where Rdesc='" + dataGridView3.Rows[j].Cells["RDesc"].Value + "'", con);
                    {
                        cmd.Parameters.Add(new SqlParameter("@C1", SqlDbType.VarChar));
                ...
                if (dataGridView3.Rows[j].Cells["RDesc"].Value.ToString().Trim() == "House A/C Address")
                {
                    SqlCommand cmd = new SqlCommand("update Rptset set Rprop=@C1 where Rdesc='" + dataGridView3.Rows[j].Cells["RDesc"].Value + "'", con);
                    {
                        cmd.Parameters.Add(new SqlParameter("@C1", SqlDbType.VarChar));
                ...
                if (dataGridView3.Rows[j].Cells["RDesc"].Value.ToString().Trim() == "PrinterType")
                {
                    SqlCommand cmd = new SqlCommand("update Rptset set Rprop=@C1 where Rdesc='" + dataGridView3.Rows[j].Cells["RDesc"].Value + "'", con);
                    {
                        cmd.Parameters.Add(new SqlParameter("@C1", SqlDbType.VarChar));
                ...
                if (Convert.ToString(dataGridView3.Rows[j].Cells["RDesc"].Value).Trim() == "Print URate")
                {
        ...
        string charPerLine, lineBelowLogo, topLine1, topLine2, topLine3, topLine4, topLine5, topLine6, topLine7,printurate;
        string mainStr;
        ...
        private void btn_testprint_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dtPrint.Rows.Count - 1; i++)
            {
               ...
               // Top Line5
                ...
                // Top Line6
                // topLine1 = "";
                else if (dtPrint.Rows[i]["Describ"].ToString() == "Print Top Line 6")
                {
                    if (dtPrint.Rows[i]["Property"].ToString() == "Yes")
                    {
                        for (int k = 0; k < dtPrint.Rows.Count - 1; k++)
                        {
                            if (dtPrint.Rows[k]["Describ"].ToString() == "Top Line6")
                            {
                                topLine6 = dtPrint.Rows[k]["Property"].ToString();
                                mainStr += topLine6;
                                for (int j = 0; j < (double.Parse(charPerLine) - topLine6.Length); j++)
                                {
                                    mainStr += " ";
                                }
                                mainStr += "\n";                                
                ...
                // Top Line7
                // topLine1 = "";
                else if (dtPrint.Rows[i]["Describ"].ToString() == "Print Top Line 7")
                {
                    if (dtPrint.Rows[i]["Property"].ToString() == "Yes")
                    {
                        for (int k = 0; k < dtPrint.Rows.Count - 1; k++)
                        {
                            if (dtPrint.Rows[k]["Describ"].ToString() == "Top Line7")
                            {
                                topLine7 = dtPrint.Rows[k]["Property"].ToString();
                                mainStr += topLine7;
                                for (int j = 0; j < (double.Parse(charPerLine) - topLine7.Length); j++)
                                {
                                    mainStr += " ";
                                }
                                mainStr += "\n";
                ...
                else if (dtPrint.Rows[i]["Describ"].ToString() == "Print URate")
                {
                    if (dtPrint.Rows[i]["Property"].ToString() == "Yes")
                    {
                        for (int k = 0; k < dtPrint.Rows.Count - 1; k++)
                        {
                            if (dtPrint.Rows[k]["Describ"].ToString() == "printurate")
                            {
                                printurate = dtPrint.Rows[k]["Property"].ToString();
                                mainStr += printurate;
                                for (int j = 0; j < (double.Parse(charPerLine) - printurate.Length); j++)
                                {
                                    mainStr += " ";
                                }
                                mainStr += "\n";
