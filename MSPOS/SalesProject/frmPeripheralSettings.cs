...
namespace SalesProject
{
    ...
    public partial class frmPeripheralSettings : Form
    {
      ...
      //  Win32PrintClass w32prn = new Win32PrintClass();
        ...
        private void PeripheralSettings_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                // if (PeripheralSettings.Equals("tabPageScale"))
                {
                    ...
                    this.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    //Pnl_Back1.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    Pnl_Cashdraw.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    Pnl_Header1.BackColor = Color.FromName(_Class.clsVariables.fPUpColor);
                    Pnl_Footer1.BackColor = Color.FromName(_Class.clsVariables.fPDownColor);
                    cmbCounter2.Focus();
                }
                ...
                // if (PeripheralSettings.Equals("tabPageScale"))
                {
                    ...
                    this.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    //Pnl_Back1.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    Pnl_CusDisplay.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    Pnl_Header2.BackColor = Color.FromName(_Class.clsVariables.fPUpColor);
                    Pnl_Footer2.BackColor = Color.FromName(_Class.clsVariables.fPDownColor);
                    cmbCounter3.Focus();
                }
                if (PeripheralSettings.SelectedTab.Name == "tabLCDDisplay")
                {
                    ...
                    this.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    //Pnl_Back1.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    pnlLCDDisplay.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    Pnl_Header3.BackColor = Color.FromName(_Class.clsVariables.fPUpColor);
                    Pnl_Footer3.BackColor = Color.FromName(_Class.clsVariables.fPDownColor);
                    cmbCtrLCD.Focus();
                }
                if (PeripheralSettings.SelectedTab.Name == "tabPrinterSettings")
                {
                    ...
                    this.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    //Pnl_Back1.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    Pnl_Printer.BackColor = Color.FromName(_Class.clsVariables.fColor);
                    Pnl_Header4.BackColor = Color.FromName(_Class.clsVariables.fPUpColor);
                    Pnl_Footer4.BackColor = Color.FromName(_Class.clsVariables.fPDownColor);
                    cmbCtrPrint.Focus();
                }
            }
            catch (Exception ex)
        ...
        private void Pnl_Printer_Paint(object sender, PaintEventArgs e)
        {
