...
namespace SalesProject._ExtraForm
{
    public partial class frmQtyaNRate : Form
    {
       ...
       SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["POS"].ToString());
        ...
        private void btnOK_Click(object sender, EventArgs e)        
        {
            ...
            else
            {
                ...
                else
                {
                        ...
                        if ((txtQty.Text == "" || txtQty.Text == null) && txtQty.Enabled == true)
                        {
                            funQtyInsert1();
                        }
                        else 
        ...
        public void funQtyInsert()
        {
            ...
            if (dtNew.Rows.Count > 0)
            {
                ...
                if (SalesProject._Class.clsVariables.itemQty != "")
                {
                    tOldQty = double.Parse(SalesProject._Class.clsVariables.itemQty);
                }
                if (txtQty.Text.Trim() != "")
                {
                ...
                if (tUnitDecimals == 0)
                {
                    SalesProject._Class.clsVariables.itemQty = (tOldQty + tNewQty).ToString("N0");
                }
                if (tUnitDecimals == 1)
                {
                    SalesProject._Class.clsVariables.itemQty = (tOldQty + tNewQty).ToString("N1");
                }
                if (tUnitDecimals == 2)
                {
                    SalesProject._Class.clsVariables.itemQty = (tOldQty + tNewQty).ToString("N2");
                }
                if (tUnitDecimals == 3)
                {
                    SalesProject._Class.clsVariables.itemQty = (tOldQty + tNewQty).ToString("N3");
                }
                if (tUnitDecimals == 4)
                {
                    SalesProject._Class.clsVariables.itemQty = (tOldQty + tNewQty).ToString("N4");
                }
                if (SalesProject._Class.clsVariables.itemRate != "")
                {
                    tOldRate = double.Parse(SalesProject._Class.clsVariables.itemRate);
                }
                if (txtRate.Text.Trim() != "")
                {
                    tNewRate =(txtRate.Text.Trim()==".")?0:double.Parse(txtRate.Text.Trim());
                }
                SalesProject._Class.clsVariables.itemRate = (tNewRate).ToString();
            }
            this.Close();
        }
        public void funQtyInsert1()
        {
            ...
            if (dtNew.Rows.Count > 0)
            {
                ...
                if (txtRate.Text.Trim() == "")
                {
                    tNewRate = (txtRate.Text.Trim() == "") ? double.Parse(_Class.clsVariables.itemRate.ToString()) : double.Parse(_Class.clsVariables.itemRate.ToString());
                }
                SalesProject._Class.clsVariables.itemRate = (tNewRate).ToString();
            }
            this.Close();
        ...
        private void btnExit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //if ((txtQty.Text == "" || txtQty.Text == null) || (txtRate.Text == "" || txtRate.Text == null))
                    //{
                    //    funQtyInsert1();
                    //}
                    //else
                    ...
                    //}
                    this.Close();
                    _Class.clsVariables.tempstopatqtyremove = "Yes";
                }
                else
                {
                    funQtyInsert();
        ...
        private void txtQty_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == '.')
            {
                if (string.IsNullOrEmpty((sender as TextBox).Text) == true)
                {
        ...
        private void txtRate_KeyPress(object sender, KeyPressEventArgs e)
       {
            ...
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && e.KeyChar != '.')
            {
                MyMessageBox.ShowBox("Key only digits","Warning");
                e.Handled = true;
            }
